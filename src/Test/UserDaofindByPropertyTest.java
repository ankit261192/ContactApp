...
public class UserDaofindByPropertyTest {
...
List<User> usres=userdao.findByProperty("address","vizag");
for(User u:usres) {
	System.out.println(u.getAddress()+" "+u.getName()+" "+u.getLoginname()+" "+u.getPhone()+" "+u.getEmail()+" "+u.getUserid());
}
